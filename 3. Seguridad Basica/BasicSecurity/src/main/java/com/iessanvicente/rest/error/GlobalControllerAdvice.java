...
public class GlobalControllerAdvice extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({PedidoNotFoundException.class, NewUserWithDifferentPasswordsException.class,
		LoteCreateException.class, LoteNotFoundException.class, SearchProductoNoResultException.class,
